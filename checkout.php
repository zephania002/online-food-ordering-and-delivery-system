                                    ...
                                    <div class="cart-totals margin-b-20">
                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        <td>Cart Subtotal</td>
                                                        <td> <?php echo "Ksh.".number_format($item_total); ?></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-color"><strong> <?php echo "Ksh.".number_format($item_total); ?></strong></td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <ul class=" list-unstyled">
                                            ...
                                            <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                    <input name="mod"  type="radio" value="mpesa" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Mpesa <img src="images/mpesal.jpg" alt="" width="90"></span> </label>
                                            </li>
                                        </ul>
